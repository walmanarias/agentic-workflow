...
React, React Native, Node (Express/Fastify), NestJS, Next.js, Remix (incl. React Router 7 framework mode), C#/ASP.NET Core, Avalonia/XAML, .NET MAUI, Python (Django/DRF, FastAPI, Flask), PostgreSQL and MongoDB.
...
- `skills/` — 10 workflow playbooks (spec-driven-development, tdd-workflow, e2e-testing, visual-qa, clean-code, stack-testing-recipes, cicd-pipelines, pr-description, xamarin-maui-migration, curation) + 13 stack-expert skills loaded in-context by the lifecycle agents
