...
4. **Green:** invoke `implementer` (and the relevant stack expert — react / react-native / node-backend / nestjs / nextjs / dotnet / avalonia / maui / database) to pass the tests with clean code.
