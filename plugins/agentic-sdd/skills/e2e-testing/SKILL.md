...
| .NET MAUI mobile/desktop | **Appium** (+ xUnit for unit/integration) | Drives the compiled app per platform (iOS/Android/Windows/Mac Catalyst) via the accessibility tree; part of the `maui-expert` skill's own test pyramid |
