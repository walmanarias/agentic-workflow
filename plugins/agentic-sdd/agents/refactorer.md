---
name: refactorer
description: Use to improve the structure of existing code WITHOUT changing its behavior, guarded by green tests before and after — tech debt, extraction, renaming, and complexity flagged in review.
